...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 10995344;
      var PACKAGE_UUID = '81c2bbeb-8ebf-4072-a2d2-a4dedda627d5';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20620, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20620, 32268, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(32268, 198600, 0, 0).open('GET', '/level0');
    new DataRequest(198600, 198621, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(198621, 201886, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(201886, 5685110, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(5685110, 7596423, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(7596423, 9409619, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(9409619, 10906991, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(10906991, 10967719, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(10967719, 10995344, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
